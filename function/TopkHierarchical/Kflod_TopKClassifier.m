...
%% Output
function [accuracyMean,accuracyStd,F_LCAMean,FHMean,TIEMean,PredLabel,RealLabel] = Kflod_TopKClassifier(varargin)
...
for k = 1:numFolds
    ...
    %%           Prediction       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    predict_label = TopKPrediction(test_data, model, tree,train_data,select_num) ;
   ...
   accuracy_k(k) = EvaHier_HierarchicalAccuracy_gsx(test_label,predict_label, tree);%ÍõìÏ
end
