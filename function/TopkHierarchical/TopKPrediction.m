...
%% Output
%  function [predict_label_KNN] = TopKPrediction(input_data, model,tree,train_data,k)
function [predict_label_RF] = TopKPrediction(input_data, model, tree,train_data,k)    
    [m,~]=size(input_data);
    root = find(tree(:,1)==0);
